...
eval "npm install /root/AddedContent/Documents/youtube-video-automator/"

# Copy the local attributes file into the config folder
eval "mv /root/AddedContent/local_attributes.js /root/AddedContent/Documents/youtube-video-automator/config/local_attributes.js"

# Add an empty 'secrets.js' file to the config folder just to prevent errors
eval "echo \"module.exports = {};\" > /root/AddedContent/Documents/youtube-video-automator/config/secrets.js"
